package praticas.collections.stream;
...
public class RefatoracaoOrdenacaoMap {
    ...
    public static void main(String[] args) {
         ...
         * Para pesquisar
         * 
         * Analisar porque a IDE está alertando sobre a necessidade de 
         * adicionar um serialVersionUID quando inicializamos os dados
         * neste formato, usando dupla chaves {UID{}}.
         * 
